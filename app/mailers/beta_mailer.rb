class BetaMailer < ActionMailer::Base
  ...
  def sign_up(invite)
    ...
    mail(:to => 'kerinin@gmail.com', :subject => "#{invite.email} signed up for BetterSheet!")
  end
  ...
  def recommend(invite)
    ...
    mail(:to => 'kerinin@gmail.com', :subject => "#{referrer} just referred #{invite.email} to BetterSheet!")
  end
end
